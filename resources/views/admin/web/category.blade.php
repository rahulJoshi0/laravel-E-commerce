                        ...
                        <div class="row product-categorie-box">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                        @foreach ($categori->products as $category)
                                            {{-- @foreach (getSubCategory($cat->id) as $category) --}}
                                                ...
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <img src="{{ $category->getFirstMediaUrl('image') }}"
                                                            class="img-fluid" alt="Image" style="height:250px">
                                                        <div class="mask-icon">
                                                            <ul>
                                                    ...
                                                    <div class="why-text">
                                                        <h1><a
                                                                href="{{ route('productData', $category->url_key) }}">{{ $category->name }}</a>
                                                        </h1>
