        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="contact-form-right">
                    ...
                    <form  action = "{{route('enquiry.store')}}" id="" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="Your Mobile" required data-error="Please enter your mobile">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
