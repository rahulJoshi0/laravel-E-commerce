            ...
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a data-toggle="collapse" href="#formLogin" role="button" aria-expanded="false">Click here to
                            Login</a></h5>
                    <form class="mt-3 collapse review-form-box" id="formLogin" action="{{route('checkout.store')}}" method="POST">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="checkout_select_address">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="billing_address"
                                        placeholder="Address" value="{{ old('billing_address') }}">
                        ...
                        <div class="second-billing-address" id="shipping-address" style="display: none">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="shipping_address"
                                    placeholder="Address" value="{{ old('shipping_address') }}">
                                ...
                                <div class="odr-box">
                                    ...
                                    <div class="rounded p-2 bg-light">
                                        <div class="media mb-2 border-bottom">
                                            {{-- {{($cartdata)}} --}}
                                            @if ($cartdata && isset($cartdata->quoteItems))
                            ...
                            <div class="col-md-12 col-lg-12">
								...
								<div class="ml-auto font-weight-bold"> $ 40 </div>
                                    ...
                                    <div class="gr-total">
                                        ...
                                        <h3 class="cart-total" style="float: right;">₹{{ $cartdata->total ??0 }}</h3>
                                        {{-- {{$cartdata}} --}}
                                    </div>
                                    <hr>
                                </div>
